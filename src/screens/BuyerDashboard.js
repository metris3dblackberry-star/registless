...
const s = StyleSheet.create({
  ...
  avatar: { width: 42, height: 42, borderRadius: 13, backgroundColor: "rgba(100,100,255,0.25)", borderWidth: 0.5, borderColor: "rgba(100,100,255,0.45)", justifyContent: "center", alignItems: "center", marginRight: 11 },
  avatarText: { color: "#cccff", fontSize: 17, fontWeight: "700" },
  partnerName: { color: "#fff", fontSize: 15, fontWeight: "600" },
  partnerCompany: { color: "#bbb", fontSize: 11, marginTop: 2 },
  sectionLabel: { color: "#aaa", fontSize: 10, letterSpacing: 0.8, textTransform: "uppercase", marginTop: 20, marginBottom: 8 },
