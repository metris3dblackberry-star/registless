...
const st = StyleSheet.create({
  ...
  searchInput: { flex: 1, backgroundColor: "rgba(45,45,45,0.92)", borderRadius: 14, padding: 14, color: "#fff", fontSize: 15, borderWidth: 1, borderColor: "#444" },
  searchBtn: { backgroundColor: "#ff7a1a", borderRadius: 14, width: 50, alignItems: "center", justifyContent: "center" },
  catGrid: { flexDirection: "row", flexWrap: "wrap", gap: 8, marginBottom: 16 },
  catBtn: { backgroundColor: "rgba(45,45,45,0.92)", borderRadius: 20, paddingHorizontal: 12, paddingVertical: 7, borderWidth: 1, borderColor: "#444" },
  ...
  card: { backgroundColor: "rgba(45,45,45,0.92)", borderRadius: 20, padding: 16, borderWidth: 1, borderColor: "#3a3a3a" },
