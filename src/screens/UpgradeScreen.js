...
const st = StyleSheet.create({
  ...
  statusBox:    { backgroundColor: "rgba(255,255,255,0.05)", borderRadius: 14, padding: 14, alignItems: "center", marginBottom: 20, borderWidth: 1, borderColor: colors.borderSubtle },
  statusBadge:  { fontSize: 16, fontWeight: "bold" },
  statusSub:    { color: colors.textSecondary, fontSize: 13, marginTop: 4, textAlign: "center" },
  card:         { backgroundColor: "rgba(20,20,20,0.7)", borderRadius: 20, padding: 20, marginBottom: 16, borderWidth: 1, borderColor: colors.borderSubtle },
